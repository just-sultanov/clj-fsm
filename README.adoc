...
image:https://github.com/just-sultanov/clj-fsm/workflows/build/badge.svg[Tests]
image:https://github.com/just-sultanov/clj-fsm/workflows/deploy/badge.svg[Tests]
